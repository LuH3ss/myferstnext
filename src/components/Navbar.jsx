...
export default function Navbar() {
    return(
        ...
        // <nav>
        //     <ul>
        //         <li class="text-3xl font-bold underline"><Link href="/">Home</Link></li>
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4">
                  ...
                  <Link href="/posts" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Posts</Link>
                </div>
              </div>
            </div>
